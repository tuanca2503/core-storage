...
impl BaseError {
    ...
    //
    #[track_caller]
    pub fn external_error(msg: impl Into<String>, code: ErrorCode) -> Self {
        Self::new(
            code as u32,
            ErrorKind::External,
            ErrorSeverity::Error,
    ...
    //
    #[track_caller]
    pub fn software_warning(msg: impl Into<String>, code: ErrorCode) -> Self {
        Self::new(
            code as u32,
            ErrorKind::Software,
    ...
    #[track_caller]
    pub fn software_error(msg: impl Into<String>, code: ErrorCode) -> Self {
        Self::new(
            code as u32,
            ErrorKind::Software,
            ErrorSeverity::Error,
    ...
    //
    #[track_caller]
    pub fn system_warning(msg: impl Into<String>, code: ErrorCode) -> Self {
        Self::new(
            code as u32,
            ErrorKind::System,
            ErrorSeverity::Warning,
    ...
    //
    #[track_caller]
    pub fn user_error(msg: impl Into<String>, code: ErrorCode) -> Self {
        Self::new(
            code as u32,
            ErrorKind::User,
            ErrorSeverity::Error,
